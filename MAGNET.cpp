...
MAGNET::MAGNET()
{
	std::fstream inputFile{"C:\\1_Jan\\DataServerClient\\Projekte\\BikeApp\\SensorBox\\ENDLESS_23_06_2023_16_27_03\\MAGNET.csv", std::ios::in};
	if (!inputFile)
	{
		status = false;
	}
	...
	inputFile.open("C:\\1_Jan\\DataServerClient\\Projekte\\BikeApp\\SensorBox\\ENDLESS_23_06_2023_16_27_03\\MAGNET.csv", std::ios::in);
	if (!inputFile)
	{
		status = false;
	}
